...
# flag = 1
if flag:
    weights = exp_w_func(beta, time_list)   # 变量传入设定的函数中
...
# flag = 1
if flag:
    beta_list = [0.98, 0.95, 0.9, 0.8]                             # 权重beta对指数加权平均的影响
    w_list = [exp_w_func(beta, time_list) for beta in beta_list]   # 变量传入设定的函数中
